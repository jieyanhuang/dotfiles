...
syn keyword mxmlSpecialTagName  contained script style
...
"  syn include @mxmlScript syntax/actionscript.vim
  ...
  unlet b:current_syntax
"  syn region  Script start=+<script[^>]*>+ keepend end=+</script>+me=s-1 contains=@mxmlScript,mxmlCssStyleComment,mxmlScriptTag,@htmlPreproc
"  syn region  Script start=+<jcss[^>]*>+ keepend end=+</jcss>+me=s-1 contains=@mxmlScript,mxmlCssStyleComment,mxmlScriptTag,@htmlPreproc
  syntax region javascript matchgroup=javascript start="<script>" end="</script>" contains=@javascript
  syntax region javascript matchgroup=javascript start="<jcss>" end="</jcss>" contains=@javascript

  syn region  mxmlScriptTag     contained start=+<script+ end=+>+       contains=htmlTagN,htmlString,htmlArg,htmlValue,htmlTagError,htmlEvent
...
"  syn sync match mxmlHighlight groupthere Script "<script"
