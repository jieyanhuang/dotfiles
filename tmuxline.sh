...
set -g status-right "#[fg=colour2]#[fg=colour18,bg=colour2,nobold,nounderscore,noitalics] Batt: #{battery_icon} #{battery_percentage} #{battery_remain}#[fg=colour19,bg=colour18,nobold,nounderscore,noitalics]#[fg=colour21,bg=colour19] %Y-%m-%d  %H:%M #[fg=colour2,bg=colour19,nobold,nounderscore,noitalics]#[fg=colour18,bg=colour2] #h "
